...
public enum ValidationError {
	...
	UPDATE_CART_USER_ID_REQUIRED(BAD_REQUEST, "userId는 필수 값 입니다"),
	UPDATE_CART_CART_ID_REQUIRED(BAD_REQUEST, "cartId는 필수 값 입니다"),
	UPDATE_CART_QUANTITY_REQUIRED(BAD_REQUEST, "수량은 필수 값 입니다"),
	UPDATE_CART_QUANTITY_INVALID(BAD_REQUEST, "유효하지않은 수량입니다"),
